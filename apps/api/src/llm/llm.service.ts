 ...
 *   1. Ollama (open weights, self-hostable — the NGO's stated requirement)
 *   2. OpenAI / Anthropic (if a key is provided)
 *   3. null  -> caller composes a deterministic answer from the sources
 */
@Injectable()
